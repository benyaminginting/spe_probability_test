  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input type="text" name="module" id="module" placeholder="" value="{$data.module}" class="form-control validate[required]" />
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input type="text" name="menu" id="menu" placeholder="" class="form-control validate[required]" value="{$data.menu}" />
        </div>
      </div>
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input type="text" name="urut" id="urut" placeholder="" class="form-control validate[required] angka" value="{$data.urut}" />
        </div>
      </div>
