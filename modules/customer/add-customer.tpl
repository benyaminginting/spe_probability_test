...
<div class="row">
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input type="text" name="username" id="username" placeholder="" class="validate[required, custom[email]] form-control" />
        </div>
      </div> 
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input type="password" id="password" name="password" class="form-control validate[required, minSize[6]]" value="{$data.password}" />
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input type="text" name="nama" id="nama" placeholder="" class="form-control validate[required]" />
        </div>
      </div> 
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input type="text" name="telpon" id="telpon" placeholder="" class="form-control validate[]" />
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input type="text" name="kota" id="kota" placeholder="" class="form-control validate[required]" />
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <textarea id="alamat" name="alamat" class="form-control validate[required]"></textarea>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input type="text" name="kodepos" id="kodepos" placeholder="" class="form-control validate[required]" />
        </div>
      </div>
