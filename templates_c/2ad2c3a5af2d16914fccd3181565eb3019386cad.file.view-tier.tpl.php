<?php /* Smarty version Smarty-3.0.8, created on 2020-09-02 05:56:35
         compiled from "C:\xampp\htdocs\spe/modules/tier/view-tier.tpl" */ ?>
<?php /*%%SmartyHeaderCode:86865f4ed1a3689403-79238239%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ad2c3a5af2d16914fccd3181565eb3019386cad' => 
    array (
      0 => 'C:\\xampp\\htdocs\\spe/modules/tier/view-tier.tpl',
      1 => 1599000979,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '86865f4ed1a3689403-79238239',
  'function' => 
  array (
  ),
		...
		success : function(r) {	
			...
			if (json.databody != null) {
				$.each(json.databody, function(m, item) {
					...
					field += '<td class="angka">'+numeral(item.min).format('0,0')+'</td>';
					field += '<td class="angka">'+numeral(item.max).format('0,0')+'</td>';
					field += '<td>'+item.prob+'</td>';
			...
			if (json.databody == "") {
				$("#tabeldata tbody").append('<tr><td colspan="6" style="text-align:center;">No available data.</td></tr>');
			}
...
function deleteSelectedItems(){
	...
	$.ajax({
	  type : 'POST',
	  url : '<?php echo $_smarty_tpl->getVariable('baseurl')->value;?>
/tier/query-delete-selected-items',
	  data : {
	    'dataid' : itemToDelete
	  },
	  beforeSend : function(){
...
/tier/add', 'Add Kategori Item');
}

function editdata(id) {
	ajaxpage('<?php echo $_smarty_tpl->getVariable('baseurl')->value;?>
/tier/edit/'+id, 'Edit Kategori Item');
}
