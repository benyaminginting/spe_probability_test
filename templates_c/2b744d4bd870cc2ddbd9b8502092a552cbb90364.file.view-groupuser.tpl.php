<?php /* Smarty version Smarty-3.0.8, created on 2020-08-31 06:58:07
         compiled from "C:\xampp\htdocs\spe\super/modules/groupuser/view-groupuser.tpl" */ ?>
<?php /*%%SmartyHeaderCode:117955f4c3d0fc03843-88037338%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2b744d4bd870cc2ddbd9b8502092a552cbb90364' => 
    array (
      0 => 'C:\\xampp\\htdocs\\spe\\super/modules/groupuser/view-groupuser.tpl',
      1 => 1598830371,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '117955f4c3d0fc03843-88037338',
  'function' => 
  array (
  ),
		...
		success : function(r) {	
			...
			if (json.databody != null) {
				$.each(json.databody, function(m, item) {
					...
					field += '<td><a class="btn btn-mini" title="Lihat user di grup ini" href="<?php echo $_smarty_tpl->getVariable('baseurl')->value;?>
/user?grup='+item.grupuser+'"> '+item.jumlahuser+' user </a><a class="btn btn-mini" title="Otorisasikan grupuser ini" href="javascript:otorisasi('+item.id+')"><i class="icon icon-user"></i></a>';
...
/auth?id='+idgrupuser, 'Otorisasi Grup user - Module');
}
function tambahdata() {
	ajaxpage('<?php echo $_smarty_tpl->getVariable('baseurl')->value;?>
/groupuser/add', 'Add Group User');
}

function editdata(id) {
	ajaxpage('<?php echo $_smarty_tpl->getVariable('baseurl')->value;?>
/groupuser/edit/'+id, 'Edit Group User');
}
...
function deleteSelectedItems(){
	...
	$.ajax({
	  type : 'POST',
	  url : '<?php echo $_smarty_tpl->getVariable('baseurl')->value;?>
/groupuser/query-delete-selected-items',
	  data : {
	    'dataid' : itemToDelete
	  },
	  beforeSend : function(){
...
/groupuser/edit/'+items[key].value);
	});
}
</script>
