<?php /* Smarty version Smarty-3.0.8, created on 2020-08-31 06:53:59
         compiled from "C:\xampp\htdocs\spe\super/modules/moduleitem/view-moduleitem.tpl" */ ?>
<?php /*%%SmartyHeaderCode:115285f4c3c17d049f4-25143461%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1808f4c9d5ed471729403a33efb6a65670cd887e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\spe\\super/modules/moduleitem/view-moduleitem.tpl',
      1 => 1598830372,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '115285f4c3c17d049f4-25143461',
  'function' => 
  array (
  ),
...
/moduleitem/add', 'Add Module Item');
}

function editdata(id) {
	ajaxpage('<?php echo $_smarty_tpl->getVariable('baseurl')->value;?>
/moduleitem/edit/'+id, 'Edit Module Item');
}
function deleteSelectedItems(){
	...
	$.ajax({
	  type : 'POST',
	  url : '<?php echo $_smarty_tpl->getVariable('baseurl')->value;?>
/moduleitem/query-delete-selected-items',
	  data : {
	    'dataid' : itemToDelete
	  },
	  beforeSend : function(){
...
/moduleitem/edit/'+items[key].value);
	});
}
</script>
