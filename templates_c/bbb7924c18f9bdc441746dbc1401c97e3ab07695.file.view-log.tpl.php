<?php /* Smarty version Smarty-3.0.8, created on 2020-09-02 10:08:41
         compiled from "C:\xampp\htdocs\spe/modules/log/view-log.tpl" */ ?>
<?php /*%%SmartyHeaderCode:284645f4f0cb9ac1646-36398488%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bbb7924c18f9bdc441746dbc1401c97e3ab07695' => 
    array (
      0 => 'C:\\xampp\\htdocs\\spe/modules/log/view-log.tpl',
      1 => 1598999783,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '284645f4f0cb9ac1646-36398488',
  'function' => 
  array (
  ),
		...
		success : function(r) {	
			...
			if (json.databody != null) {
				$.each(json.databody, function(m, item) {
					...
					field += '<td>'+item.remote_addr+'</td>';
					field += '<td>'+item.server_info+'</td>';
					field += '<td>'+item.data+'</td>';
					field += '<td>' + item.request_time + '</td>';
...
function deleteSelectedItems(){
	...
	$.ajax({
	  type : 'POST',
	  url : '<?php echo $_smarty_tpl->getVariable('baseurl')->value;?>
/log/query-delete-selected-items',
	  data : {
	    'dataid' : itemToDelete
	  },
	  beforeSend : function(){
