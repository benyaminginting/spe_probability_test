<?php /* Smarty version Smarty-3.0.8, created on 2020-08-31 06:39:35
         compiled from "C:\xampp\htdocs\spe\super/modules/catproduct/view-catproduct.tpl" */ ?>
<?php /*%%SmartyHeaderCode:89975f4c38b736db96-14584719%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '96c0752fe974acc42b1691b5e8967c0032aee1a7' => 
    array (
      0 => 'C:\\xampp\\htdocs\\spe\\super/modules/catproduct/view-catproduct.tpl',
      1 => 1598830370,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '89975f4c38b736db96-14584719',
  'function' => 
  array (
  ),
...
/catproduct/add', 'Add Category Product');
}

function editdata(id) {
	ajaxpage('<?php echo $_smarty_tpl->getVariable('baseurl')->value;?>
/catproduct/edit/'+id, 'Edit Category Product');
}
...
function deleteSelectedItems(){
	...
	$.ajax({
	  type : 'POST',
	  url : '<?php echo $_smarty_tpl->getVariable('baseurl')->value;?>
/catproduct/query-delete-selected-items',
	  data : {
	    'dataid' : itemToDelete
	  },
	  beforeSend : function(){
...
/catproduct/edit/'+items[key].value);
	});
}
