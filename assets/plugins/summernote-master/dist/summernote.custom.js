      ...
      image: function (lang, options) {
        ...
        var body = '<div class="form-group row note-group-select-from-files">' +
                   ...
                   '<div class="form-group row">' +
                     ...
                     '<input class="note-image-url form-control col-md-12" type="text" id="summernoteIzyImage_'+uniqueId+'" />' +
					 '<button type="button" class="btn" title="Browse Image" onclick="browseImage(\'summernoteIzyImage_'+uniqueId+'\')">Browse</button>' +
                   '</div>';
